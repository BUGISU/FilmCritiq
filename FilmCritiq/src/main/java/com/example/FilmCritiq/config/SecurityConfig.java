package com.example.FilmCritiq.config;
import com.example.FilmCritiq.security.handler.CustomAccessDeniedHandler;
import com.example.FilmCritiq.security.handler.CustomAuthenticationFailureHandler;
import com.example.FilmCritiq.security.handler.CustomLoginSuccessHandler;
import com.example.FilmCritiq.security.handler.CustomLogoutSuccessHandler;
  ...
  protected SecurityFilterChain config(HttpSecurity httpSecurity)
    ...
    httpSecurity.authorizeHttpRequests(
        auth -> auth
            ...
            //.requestMatchers("/movies/list").permitAll()
